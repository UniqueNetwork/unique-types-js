...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    QuartzRuntimeRuntimeCommonDataManagementFilterIdentity: QuartzRuntimeRuntimeCommonDataManagementFilterIdentity;
