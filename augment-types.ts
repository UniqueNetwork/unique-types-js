...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    UniqueRuntimeRuntimeCommonDataManagementFilterIdentity: UniqueRuntimeRuntimeCommonDataManagementFilterIdentity;
