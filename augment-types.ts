...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    UniqueRuntimeRuntimeCommonFeeCoefficientApplier: UniqueRuntimeRuntimeCommonFeeCoefficientApplier;
