...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    QuartzRuntimeRuntimeCommonFeeCoefficientApplier: QuartzRuntimeRuntimeCommonFeeCoefficientApplier;
