...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    QuartzRuntimeRuntimeHoldReason: QuartzRuntimeRuntimeHoldReason;
    QueryId: QueryId;
