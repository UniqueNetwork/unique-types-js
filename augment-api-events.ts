...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    balances: {
       ...
       **/
      BurnedHeld: AugmentedEvent<ApiType, [reason: UniqueRuntimeRuntimeHoldReason, who: AccountId32, amount: u128], { reason: UniqueRuntimeRuntimeHoldReason, who: AccountId32, amount: u128 }>;
      /**
       ...
       **/
      Held: AugmentedEvent<ApiType, [reason: UniqueRuntimeRuntimeHoldReason, who: AccountId32, amount: u128], { reason: UniqueRuntimeRuntimeHoldReason, who: AccountId32, amount: u128 }>;
      /**
       ...
       **/
      Released: AugmentedEvent<ApiType, [reason: UniqueRuntimeRuntimeHoldReason, who: AccountId32, amount: u128], { reason: UniqueRuntimeRuntimeHoldReason, who: AccountId32, amount: u128 }>;
      /**
       ...
       **/
      TransferAndHold: AugmentedEvent<ApiType, [reason: UniqueRuntimeRuntimeHoldReason, source: AccountId32, dest: AccountId32, transferred: u128], { reason: UniqueRuntimeRuntimeHoldReason, source: AccountId32, dest: AccountId32, transferred: u128 }>;
      /**
       * A transfer of `amount` on hold from `source` to `dest` was initiated.
       **/
      TransferOnHold: AugmentedEvent<ApiType, [reason: UniqueRuntimeRuntimeHoldReason, source: AccountId32, dest: AccountId32, amount: u128], { reason: UniqueRuntimeRuntimeHoldReason, source: AccountId32, dest: AccountId32, amount: u128 }>;
      /**
