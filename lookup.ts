...
export default {
  ...
  /**
   * Lookup367: pallet_configuration::AppPromotionConfiguration<BlockNumber>
   **/
  ...
  /**
   * Lookup371: pallet_template_transaction_payment::Call<T>
   **/
  PalletTemplateTransactionPaymentCall: 'Null',
  /**
   * Lookup372: pallet_structure::pallet::Call<T>
   **/
  PalletStructureCall: 'Null',
  /**
   * Lookup373: pallet_app_promotion::pallet::Call<T>
   **/
  ...
  /**
   * Lookup374: pallet_foreign_assets::module::Call<T>
   **/
  ...
  /**
   * Lookup391: pallet_evm_coder_substrate::pallet::Call<T>
   **/
  PalletEvmCoderSubstrateCall: {
    _enum: ['empty_call']
  },
  /**
   * Lookup392: pallet_evm_contract_helpers::pallet::Call<T>
   **/
  ...
  /**
   * Lookup394: pallet_evm_migration::pallet::Call<T>
   **/
  ...
  /**
   * Lookup399: pallet_test_utils::pallet::Call<T>
   **/
  PalletTestUtilsCall: {
    _enum: {
      enable: 'Null',
  ...
  /**
   * Lookup404: orml_xtokens::module::Error<T>
   **/
  OrmlXtokensModuleError: {
    _enum: ['AssetHasNoReserve', 'NotCrossChainTransfer', 'InvalidDest', 'NotCrossChainTransferableCurrency', 'UnweighableMessage', 'XcmExecutionFailed', 'CannotReanchor', 'InvalidAncestry', 'InvalidAsset', 'DestinationNotInvertible', 'BadVersion', 'DistinctReserveForAssetAndFee', 'ZeroFee', 'ZeroAmount', 'TooManyAssetsBeingSent', 'AssetIndexNonExistent', 'FeeNotEnough', 'NotSupportedMultiLocation', 'MinXcmFeeNotDefined']
  },
  /**
   * Lookup407: orml_tokens::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup409: orml_tokens::AccountData<Balance>
   **/
  ...
  /**
   * Lookup411: orml_tokens::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup413: orml_tokens::module::Error<T>
   **/
  ...
  /**
   * Lookup454: xcm::VersionedAssetId
   **/
  XcmVersionedAssetId: {
    _enum: {
      __Unused0: 'Null',
  ...
  /**
   * Lookup455: pallet_xcm::pallet::RemoteLockedFungibleRecord
   **/
  ...
  /**
   * Lookup460: cumulus_pallet_xcm::pallet::Error<T>
   **/
  ...
  /**
   * Lookup469: pallet_unique::Error<T>
   **/
  PalletUniqueError: {
    _enum: ['CollectionDecimalPointLimitExceeded', 'EmptyArgument', 'RepartitionCalledOnNonRefungibleCollection']
  },
  /**
   * Lookup470: pallet_configuration::pallet::Error<T>
   **/
  PalletConfigurationError: {
    _enum: ['InconsistentConfiguration']
  },
  /**
   * Lookup471: up_data_structs::Collection<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup472: up_data_structs::SponsorshipState<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup473: up_data_structs::Properties
   **/
  ...
  /**
   * Lookup474: up_data_structs::PropertiesMap<bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  UpDataStructsPropertiesMapBoundedVec: 'BTreeMap<Bytes, Bytes>',
  /**
   * Lookup479: up_data_structs::PropertiesMap<up_data_structs::PropertyPermission>
   **/
  UpDataStructsPropertiesMapPropertyPermission: 'BTreeMap<Bytes, UpDataStructsPropertyPermission>',
  /**
   * Lookup486: up_data_structs::CollectionStats
   **/
  ...
  /**
   * Lookup487: up_data_structs::TokenChild
   **/
  ...
  /**
   * Lookup488: PhantomType::up_data_structs<T>
   **/
  PhantomTypeUpDataStructs: '[(UpDataStructsTokenData,UpDataStructsRpcCollection,UpPovEstimateRpcPovInfo);0]',
  /**
   * Lookup490: up_data_structs::TokenData<pallet_evm::account::BasicCrossAccountIdRepr<sp_core::crypto::AccountId32>>
   **/
  ...
  /**
   * Lookup492: up_data_structs::RpcCollection<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup493: up_data_structs::RpcCollectionFlags
   **/
  ...
  /**
   * Lookup570: opal_runtime::runtime_common::identity::DisableIdentityCalls
   **/
