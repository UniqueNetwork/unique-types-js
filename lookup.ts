...
export default {
  ...
  /**
   * Lookup179: cumulus_pallet_parachain_system::CodeUpgradeAuthorization<T>
   **/
  ...
  /**
   * Lookup197: quartz_runtime::runtime_common::SessionKeys
   **/
  ...
  /**
   * Lookup313: pallet_unique::pallet::Call<T>
   **/
  PalletUniqueCall: {
    _enum: {
      create_collection: {
  ...
  /**
   * Lookup463: pallet_unique::pallet::Error<T>
   **/
  PalletUniqueError: {
