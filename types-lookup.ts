...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletConfigurationAppPromotionConfiguration (367) */
  ...
  /** @name PalletTemplateTransactionPaymentCall (371) */
  type PalletTemplateTransactionPaymentCall = Null;

  /** @name PalletStructureCall (372) */
  type PalletStructureCall = Null;

  /** @name PalletAppPromotionCall (373) */
  ...
  /** @name PalletForeignAssetsModuleCall (374) */
  ...
  /** @name PalletEvmMigrationCall (394) */
  ...
  /** @name OrmlXtokensModuleError (404) */
  ...
  /** @name OrmlTokensBalanceLock (407) */
  interface OrmlTokensBalanceLock extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensAccountData (409) */
  ...
  /** @name OrmlTokensReserveData (411) */
  interface OrmlTokensReserveData extends Struct {
    readonly id: Null;
    readonly amount: u128;
  }

  /** @name OrmlTokensModuleError (413) */
  ...
  /** @name CumulusPalletXcmError (460) */
  ...
  /** @name PalletConfigurationError (470) */
  interface PalletConfigurationError extends Enum {
    readonly isInconsistentConfiguration: boolean;
    readonly type: 'InconsistentConfiguration';
  }

  /** @name UpDataStructsCollection (471) */
  ...
  /** @name UpDataStructsSponsorshipStateAccountId32 (472) */
  ...
  /** @name UpDataStructsProperties (473) */
  ...
  /** @name UpDataStructsPropertiesMapBoundedVec (474) */
  interface UpDataStructsPropertiesMapBoundedVec extends BTreeMap<Bytes, Bytes> {}

  /** @name UpDataStructsPropertiesMapPropertyPermission (479) */
  interface UpDataStructsPropertiesMapPropertyPermission extends BTreeMap<Bytes, UpDataStructsPropertyPermission> {}

  /** @name UpDataStructsCollectionStats (486) */
  ...
  /** @name UpDataStructsTokenChild (487) */
  interface UpDataStructsTokenChild extends Struct {
    readonly token: u32;
    readonly collection: u32;
  }

  /** @name PhantomTypeUpDataStructs (488) */
  ...
  /** @name UpDataStructsTokenData (490) */
  ...
  /** @name UpDataStructsRpcCollection (492) */
  ...
  /** @name UpDataStructsRpcCollectionFlags (493) */
  ...
  /** @name OpalRuntimeRuntimeCommonIdentityDisableIdentityCalls (570) */
